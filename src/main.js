...
import "./assets/auth0-theme.min.css";
...
import { faPersonBiking, faVideo, faFilm, faRecordVinyl, faMusic } from "@fortawesome/free-solid-svg-icons";
...
library.add(faPersonBiking, faVideo, faFilm, faRecordVinyl, faMusic);
dom.watch();
